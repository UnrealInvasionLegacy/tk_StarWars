class M_CloneTrooperY extends tk_NaliFighter
    config(tk_Monsters);
...
{
     FireRateScale=1.3
     WeaponClassName(0)="tk_StarWars.DC15x"
	...
	HP=100
     ...
     Skins(0)=Shader'tk_StarWars.CloneTrooper.torso_yellows'
     Skins(1)=Shader'tk_StarWars.CloneTrooper.helmet_5'
